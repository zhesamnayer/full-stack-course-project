...
export default function Expenses() {
  ...
  const fetchExpenses = async () => {
    try {
      ...
      const res = await fetch(`${baseUrl}/api/v1/expenses/list`, {
        headers: {
  ...
  const handleInsert = async() => {
    const newRecord = {
      ...
      const res = await fetch(`${baseUrl}/api/v1/expenses/add`, {
        method: "POST",
        headers: {
  ...
  const handleDelete = async(id) => {
      ...
      const res = await fetch(`${baseUrl}/api/v1/expenses/delete?id=${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleUpdate = async(row) => {
      ...
      const res = await fetch(`${baseUrl}/api/v1/expenses/update`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
